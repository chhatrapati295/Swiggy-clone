...
const Header = () => {
  ...
  const findRestaurants = async (placeId) => {
    ...
    localStorage.setItem(
      "location_details",
      JSON.stringify(placeRes?.data && placeRes?.data[0]?.geometry?.location)
    );
  ...
  return (
    <div className="py-4 px-12 border-b flex justify-between items-center shadow-md fixed w-full bg-white z-50">
      <div className="flex gap-8 items-center">
        <Link to={'/'}><svg
          className="_8pSp- hover:scale-110 transition-all duration-200"
          viewBox="0 0 559 825"
          height="46"
          width="38"
          fill="#fc8019"
